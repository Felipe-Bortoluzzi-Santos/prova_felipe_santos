...
if(isset($_GET['id']) && is_numeric($_GET['id'])){
    ...
    if($stmt->execute()){
        echo "<script>alert('funcionario excluido com sucesso');window.location.href='excluir_usuario.php';</script>";
    } else {
        echo "<script>alert('Erro ao excluir funcionario');window.location.href='principal.php';</script>";
    }
}
?>
<!DOCTYPE html>
        ...
        <table>
            ...
            <?php foreach($usuarios as $usuario) : ?>
                <tr>
                    ...
                    <td<?=htmlspecialchars($usuario['id_telefone']) ?></td>
                    <td<?=htmlspecialchars($usuario['email']) ?></td></td>
                    <td><a href="excluir_usuario.php?id=<?=htmlspecialchars($usuario['id_funcionario']) ?>" onclick="return confirm('Tem certeza que deseja excluir este funcionario?')">Excluir</a></td>
                </tr>
            <? endforeach ?>
        </table>
    <? else : ?>
